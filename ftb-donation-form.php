...
function ftb_donation_form_activate() {
	...
	add_option( 'ftb_amount_options', array( '5', '10', '25' ) );
	...
	add_option( 'ftb_designated_managers', array() );
}
...
function ftb_donation_form_deactivate() {
	...
	foreach ( (array) get_option( 'ftb_designated_managers', array() ) as $user_id ) {
